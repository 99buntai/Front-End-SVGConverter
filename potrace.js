 ...
 *   loadImageFromCanvas(canvas): load image from canvas element
...
var Potrace = (function() {
  ...
  function loadImageFromCanvas(canvas) {
    ...
    // Create new canvas to ensure we have the correct context
    imgCanvas.width = canvas.width;
    imgCanvas.height = canvas.height;
    var ctx = imgCanvas.getContext('2d', { willReadFrequently: true });
    
    // Draw the input canvas onto our working canvas
